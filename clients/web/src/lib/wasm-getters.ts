import {
  ...
  WasmGrantService, WasmEntitlementService,
...
export function registerAll(client: WasmApiClient, authManager: WasmAuthManager) {
  registerServiceProvider({
    ...
    entitlementService: client.create_entitlement_service(),
    ...
    entitlementState: client.get_entitlement_state(),
...
export {
  ...
  getChannelState, getWorkflowState, getLoopalManager,
  getLoopBuilderState,
