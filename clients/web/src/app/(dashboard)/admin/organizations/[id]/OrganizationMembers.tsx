    ...
    <section className="border-t border-border pt-5">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h2 className="text-sm font-semibold">
          {t("organizations.membersHeading", { count: members.length })}
        </h2>
      </div>
      {members.length === 0 ? (
        <EmptyState
          size="compact"
          title={t("organizations.membersEmptyTitle")}
          description={t("organizations.membersEmptyDescription")}
        />
      ) : (
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <p className="truncate text-sm font-medium">
                    {member.user?.name
                      ...
                      || t("organizations.memberFallbackName", { id: String(member.user_id) })}
                  </p>
