...
case "${AGENT_RUNTIME}" in
    claude-code|codex-cli|video-studio|cursor-cli|gemini-cli|kimi-code|minimax-cli|e2e-echo|loopal|do-agent|aider|opencode|grok-build|openclaw|hermes|pi-agent) ;;
    *)
